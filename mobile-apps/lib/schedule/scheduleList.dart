...
import 'package:kbti_ceritainaja/schedule/acceptSchedule.dart';
import 'package:kbti_ceritainaja/schedule/inputschedule.dart';

class ScheduleList extends StatefulWidget {
  ScheduleList({Key key, this.title}) : super(key: key);
  final String title;
    ...
    return Scaffold(
                  ...
                  return Card(
                    ...
                    child: Container(
                      child: ListTile(
                        ...
                        subtitle: listSchedule[position].isAccept == "0" ? Text("Not accepted yet") :
                        listSchedule[position].isAccept == "1" ? Text("Accepted") : Text("Denied"),
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => AcceptSchedule(title: "Accept Schedule",
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => InputSchedule(title: "Input Schedule"))
          ).then(onGoBack);
        },
